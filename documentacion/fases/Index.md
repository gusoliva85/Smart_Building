...
| **[Fase 2](<Fase 02 - Gestión financiera básica.md>)** — Gestión financiera básica | ✅ Completa (18/18) | Ciclo financiero completo: coeficiente por unidad (con su propia pantalla de Configuración) → gastos → expensa mensual (con reemplazo confirmado de la última si hace falta corregirla) → pago con conciliación manual → deudores calculados. Primera pantalla real para Propietario/Inquilino (`financiero.html`, "Mi cuenta"). Fondos, Caja chica, Presupuestos y Facturas agrupados en una sub-navegación propia. Prueba manual de punta a punta hecha con datos reales en dos edificios distintos. |
