...
from app.routers import auth, edificios, financiero, ordentrabajo, reclamos, usuarios
...
app.include_router(ordentrabajo.router)
app.include_router(ordentrabajo.router_edificio)
